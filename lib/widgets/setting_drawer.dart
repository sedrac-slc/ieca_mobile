...
class _SettingDrawerState extends State<SettingDrawer> {
  ...
  Widget build(BuildContext context) {
    final _preferenceRepository = Provider.of<PreferenceRepository>(context, listen: false);
    return  Drawer(
      child: ListView(
        ...
        children: [
           DrawerHeader(
            ...
            child: Row(
              ...
              children: [
                Text(AppLocalizations.of(context)?.settings ?? 'Definições'),
                InkWell(
            ...
            child: ValueListenableBuilder<List<LanguageSection>>(
              ...
              builder: (_, _, _) {
                return Column(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)?.hymnalSection ?? "Secção do hinário",
                        ...
                        return DropdownButton<LanguageSection>(
                          ...
                          onChanged: (LanguageSection? newValue) {
                            if (newValue != null) {
                              ...
                              _preferenceRepository.changeLanguageSectionHymnal(newValue);
                            }
                          },
                        );
                      },
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppLocalizations.of(context)?.applicationLanguage ?? "Idioma do aplicativo",
                  style: GoogleFonts.roboto(fontSize: 15),
                ),
                DropdownButton<String>(
                  ...
                  items: [
                    DropdownMenuItem(
                      value: "pt",
                      child: Text(AppLocalizations.of(context)?.portuguese ?? "Português"),
                    ),
                    DropdownMenuItem(
                      value: "en",
                      child: Text(AppLocalizations.of(context)?.english ?? "Inglês"),
                    ),
                  ],
